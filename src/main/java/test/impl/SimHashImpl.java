...
public class SimHashImpl implements SimHash {
    ...
    public SimHashImpl(String tokens) throws IOException {
        this.tokens = tokens;
        this.intSimHash = this.simHash();
    }

    public SimHashImpl(String tokens, int hashbits) throws IOException {
        this.tokens = tokens;
    ...
    public List subByDistance(SimHashImpl simHash, int distance) {
        // 分成几组来检查
    ...
    @SneakyThrows
    public String checkDup(String s1, String s2 ) {
        SimHashImpl hash1 = new SimHashImpl(s1, 64);
        System.out.println(hash1.intSimHash + "  " + hash1.intSimHash.bitLength());
        SimHashImpl hash2 = new SimHashImpl(s2,64);
